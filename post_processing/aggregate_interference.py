...
"""
This script loads simulation data from pickle files, propagates satellite positions from TLE files, and calculates radio frequency (RF) interference-to-noise ratio (INR) metrics for user cells across channels. It provides a Streamlit user interface with a map visualization of spatial cell boundaries with interference thresholds, scenario performance metrics, and detailed tabular summaries of beam configurations and per cell spectrum allocations.
"""
