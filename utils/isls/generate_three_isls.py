...
def generate_three_isls(output_filename_isls, n_orbits, n_sats_per_orbit, isl_shift, idx_offset=0):
    """
...
def generate_three_isls_shells(output_filename_isls, n_shells, n_orbits, n_sats_per_orbit, isl_shift, idx_offset=0):
    """
    Generate plus grid ISL file.
